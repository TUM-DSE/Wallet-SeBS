...
class HTTPTrigger(Trigger):
    ...
    @staticmethod
    def typename() -> str:
        return "GramineNative.HTTPTrigger"
...
class GramineNativeFunction(Function):
    def __init__(
        self,
        name: str,
        benchmark: str,
    ...
    @staticmethod
    def typename() -> str:
        return "GramineNative.GramineNativeFunction"
    ...
    @staticmethod
    def deserialize(cached_config: dict) -> "GramineNativeFunction":
