...
from sebs.wallet.function import WalletFunction
from sebs.wallet.storage import Minio
...
class Wallet(System):
    ...
    def is_configuration_changed(
        ...
        function = cast(WalletFunction, cached_function)
    ...
    def enforce_cold_start(self, functions: List[Function], code_package: Benchmark):
        for function in functions:
            function = cast(WalletFunction, function)
            function.stop()
