    ...
    def sync_invoke(self, payload: dict) -> ExecutionResult:
        ...
        if not self.function._running:
            ...
            with wallet.Wallet() as w:
                ...
                self.logging.info(f"Created zygote {zygote} for warm start")
            ...
            self.function._context = subprocess.Popen([
                ...
                '9002',
                f'{zygote.process_id}',
                f'{self.function._code_location}/function/function.py'
            ], env=environment)
...
class WalletWarmFunction(Function):
    def __init__(
        self,
        name: str,
        benchmark: str,
    ...
    @staticmethod
    def typename() -> str:
        return "WalletWarm.WalletFunction"
    ...
    @staticmethod
    def deserialize(cached_config: dict) -> "WalletWarmFunction":
        function = WalletWarmFunction(
            cached_config["name"],
