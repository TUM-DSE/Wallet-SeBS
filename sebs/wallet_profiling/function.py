...
class HTTPTrigger(Trigger):
    ...
    @staticmethod
    def typename() -> str:
        return "WalletProfiling.HTTPTrigger"
...
class WalletProfilingFunction(Function):
    def __init__(
        self,
        name: str,
        benchmark: str,
    ...
    @staticmethod
    def typename() -> str:
        return "WalletProfiling.WalletFunction"
    ...
    @staticmethod
    def deserialize(cached_config: dict) -> "WalletProfilingFunction":
        function = WalletProfilingFunction(
            cached_config["name"],
