...
parser.add_argument(
    "--deployment", default=None, choices=["local", "cvm", "kata_qemu", "kata_fc", "gramine", "gramine_native", "wallet", "wallet_warm", "wallet_profiling", "wallet_remote","aws", "azure", "gcp"], action="store"
)
